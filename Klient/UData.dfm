object DataModule1: TDataModule1
  ...
  object zqryMaxnumer: TZQuery
    Connection = ZCon
    Active = True
    SQL.Strings = (
      'select MAX(numer_zamowienia) from zamowienia')
    Params = <>
    Left = 208
    Top = 320
    object intgrfldMaxnumermax: TIntegerField
      FieldName = 'max'
      ReadOnly = True
    end
  end
  object dsMaxnumer: TDataSource
    DataSet = zqryMaxnumer
    Left = 264
    Top = 328
  end
end
