...
type
  TDataModule1 = class(TDataModule)
    ...
    fltfldzqryszczegolysum: TFloatField;
    intgrfld_zamowienia1: TIntegerField;
    zqryRaportMsc: TZQuery;
    dsRaportMsc: TDataSource;
    wdstrngfldRaportMsclogin: TWideStringField;
    wdstrngfldRaportMscimie: TWideStringField;
    wdstrngfldRaportMscnazwisko: TWideStringField;
    intgrfldRaportMscnumer_zamowienia: TIntegerField;
    dtfldRaportMscdata_zamowienia: TDateField;
    fltfldRaportMscsum: TFloatField;
    intgrfldRaportMscidstatusy: TIntegerField;
    dtfld_zamowienia1: TDateField;
    zqryrauz: TZQuery;
    dsrauz: TDataSource;
    wdstrngfldzqryrauzlogin: TWideStringField;
    wdstrngfldzqryrauzimie: TWideStringField;
    wdstrngfldzqryrauznazwisko: TWideStringField;
    dtfld_zamowienia2: TDateField;
    intgrfldzqryrauzidstatusy: TIntegerField;
